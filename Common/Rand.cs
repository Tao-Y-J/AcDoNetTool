...
namespace AcDoNetTool.Common
{
    public class Rand
    {
        ...
        {
            return GetCharAndNum(Length, false);
        }
        ...
        /// <param name="Sleep">是否要在生成前将当前线程阻止以避免重复</param>
        /// <returns></returns>
        public static string GetCharAndNum(int Length, bool Sleep)
        {
            if (Sleep)
                System.Threading.Thread.Sleep(3);
        ...
        /// <param name="Sleep">是否要在生成前将当前线程阻止以避免重复</param>
        /// <returns></returns>
        public static string GetChar(int Length, bool Sleep)
        {
