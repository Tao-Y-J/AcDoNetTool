    ...
    public static class HatchTool
    {
        ...
        public static ObjectId HatchGradient(this Database db, short colorIndex1, short colorIndex2, string hatchGradientName, ObjectId entId)
        {
            ...
            using (Transaction trans = db.TransactionManager.StartTransaction())
            {
                ...
                {
                    // 设置填充类型为渐变类型填充
                    HatchObjectType = HatchObjectType.GradientObject
                };
                // 设置渐变填充的类型和渐变填充的图案名称
        ...
        /// <param name="hatchColorIndex"></param>
        /// <param name="entid"></param>
        /// <returns></returns>
        public static ObjectId HatchEntity(this Database db, Color bkColor, int hatchColorIndex, ObjectId entid)
        {
            ObjectId hatchId = ObjectId.Null;
            using (Transaction trans = db.TransactionManager.StartTransaction())
            {
